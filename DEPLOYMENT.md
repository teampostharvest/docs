...
| `GO_WORKER_BASE_URL` | `http://127.0.0.1:8080` | go worker base URL; the compose stack (M6) overrides the backend default to `http://go:8080` (compose service name on the `isolated` network) |
